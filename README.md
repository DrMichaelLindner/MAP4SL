...
MAP4SL is a Matlab tool which is designed to identify the effect of an artefact in MRI data on other areas depending on the slice leakage in multiband EPI functional images.
